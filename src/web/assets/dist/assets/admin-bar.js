...
\f\r]`,L=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,gt=/-->/g,mt=/>/g,E=RegExp(`>|${Y}(?:([^\\s"'>=/]+)(${Y}*=${Y}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),vt=/'/g,ft=/"/g,kt=/^(?:script|style|textarea|title)$/i,ie=e=>(t,...o)=>({_$litType$:e,strings:t,values:o}),d=ie(1),T=Symbol.for("lit-noChange"),c=Symbol.for("lit-nothing"),yt=new WeakMap,C=P.createTreeWalker(P,129);function St(e,t){if(!st(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return bt!==void 0?bt.createHTML(t):t}const ne=(e,t)=>{const o=e.length-1,r=[];let a,s=t===2?"<svg>":t===3?"<math>":"",i=L;for(let h=0;h<o;h++){const l=e[h];let u,m,p=-1,$=0;for(;$<l.length&&(i.lastIndex=$,m=i.exec(l),m!==null);)$=i.lastIndex,i===L?m[1]==="!--"?i=gt:m[1]!==void 0?i=mt:m[2]!==void 0?(kt.test(m[2])&&(a=RegExp("</"+m[2],"g")),i=E):m[3]!==void 0&&(i=E):i===E?m[0]===">"?(i=a??L,p=-1):m[1]===void 0?p=-2:(p=i.lastIndex-m[2].length,u=m[1],i=m[3]===void 0?E:m[3]==='"'?ft:vt):i===ft||i===vt?i=E:i===gt||i===mt?i=L:(i=E,a=void 0);const _=i===E&&e[h+1].startsWith("/>")?" ":"";s+=i===L?l+ae:p>=0?(r.push(u),l.slice(0,p)+wt+l.slice(p)+S+_):l+S+(p===-2?h:_)}return[St(e,s+(e[o]||"<?>")+(t===2?"</svg>":t===3?"</math>":"")),r]};class q{constructor({strings:t,_$litType$:o},r){let a;this.parts=[];let s=0,i=0;const h=t.length-1,l=this.parts,[u,m]=ne(t,o);if(this.el=q.createElement(u,r),C.currentNode=this.el.content,o===2||o===3){const p=this.el.content.firstChild;p.replaceWith(...p.childNodes)}for(;(a=C.nextNode())!==null&&l.length<h;){if(a.nodeType===1){if(a.hasAttributes())for(const p of a.getAttributeNames())if(p.endsWith(wt)){const $=m[i++],_=a.getAttribute(p).split(S),W=/([.?@])?(.*)/.exec($);l.push({type:1,index:s,name:W[2],strings:_,ctor:W[1]==="."?de:W[1]==="?"?ce:W[1]==="@"?he:Z}),a.removeAttribute(p)}else p.startsWith(S)&&(l.push({type:6,index:s}),a.removeAttribute(p));if(kt.test(a.tagName)){const p=a.textContent.split(S),$=p.length-1;if($>0){a.textContent=X?X.emptyScript:"";for(let _=0;_<$;_++)a.append(p[_],I()),C.nextNode(),l.push({type:2,index:++s});a.append(p[$],I())}}}else if(a.nodeType===8)if(a.data===At)l.push({type:2,index:s});else{let p=-1;for(;(p=a.data.indexOf(S,p+1))!==-1;)l.push({type:7,index:s}),p+=S.length-1}s++}}static createElement(t,o){const r=P.createElement("template");return r.innerHTML=t,r}}function D(e,t,o=e,r){if(t===T)return t;let a=r!==void 0?o._$Co?.[r]:o._$Cl;const s=z(t)?void 0:t._$litDirective$;return a?.constructor!==s&&(a?._$AO?.(!1),s===void 0?a=void 0:(a=new s(e),a._$AT(e,o,r)),r!==void 0?(o._$Co??=[])[r]=a:o._$Cl=a),a!==void 0&&(t=D(e,a._$AS(e,t.values),a,r)),t}class le{constructor(t,o){this._$AV=[],this._$AN=void 0,this._$AD=t,this._$AM=o}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(t){const{el:{content:o},parts:r}=this._$AD,a=(t?.creationScope??P).importNode(o,!0);C.currentNode=a;let s=C.nextNode(),i=0,h=0,l=r[0];for(;l!==void 0;){if(i===l.index){let u;l.type===2?u=new j(s,s.nextSibling,this,t):l.type===1?u=new l.ctor(s,l.name,l.strings,this,t):l.type===6&&(u=new pe(s,this,t)),this._$AV.push(u),l=r[++h]}i!==l?.index&&(s=C.nextNode(),i++)}return C.currentNode=P,a}p(t){let o=0;for(const r of this._$AV)r!==void 0&&(r.strings!==void 0?(r._$AI(t,r,o),o+=r.strings.length-2):r._$AI(t[o])),o++}}class j{get _$AU(){return this._$AM?._$AU??this._$Cv}constructor(t,o,r,a){this.type=2,this._$AH=c,this._$AN=void 0,this._$AA=t,this._$AB=o,this._$AM=r,this.options=a,this._$Cv=a?.isConnected??!0}get parentNode(){let t=this._$AA.parentNode;const o=this._$AM;return o!==void 0&&t?.nodeType===11&&(t=o.parentNode),t}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(t,o=this){t=D(this,t,o),z(t)?t===c||t==null||t===""?(this._$AH!==c&&this._$AR(),this._$AH=c):t!==this._$AH&&t!==T&&this._(t):t._$litType$!==void 0?this.$(t):t.nodeType!==void 0?this.T(t):se(t)?this.k(t):this._(t)}O(t){return this._$AA.parentNode.insertBefore(t,this._$AB)}T(t){this._$AH!==t&&(this._$AR(),this._$AH=this.O(t))}_(t){this._$AH!==c&&z(this._$AH)?this._$AA.nextSibling.data=t:this.T(P.createTextNode(t)),this._$AH=t}$(t){const{values:o,_$litType$:r}=t,a=typeof r=="number"?this._$AC(t):(r.el===void 0&&(r.el=q.createElement(St(r.h,r.h[0]),this.options)),r);if(this._$AH?._$AD===a)this._$AH.p(o);else{const s=new le(a,this),i=s.u(this.options);s.p(o),this.T(i),this._$AH=s}}_$AC(t){let o=yt.get(t.strings);return o===void 0&&yt.set(t.strings,o=new q(t)),o}k(t){st(this._$AH)||(this._$AH=[],this._$AR());const o=this._$AH;let r,a=0;for(const s of t)a===o.length?o.push(r=new j(this.O(I()),this.O(I()),this,this.options)):r=o[a],r._$AI(s),a++;a<o.length&&(this._$AR(r&&r._$AB.nextSibling,a),o.length=a)}_$AR(t=this._$AA.nextSibling,o){for(this._$AP?.(!1,!0,o);t!==this._$AB;){const r=t.nextSibling;t.remove(),t=r}}setConnected(t){this._$AM===void 0&&(this._$Cv=t,this._$AP?.(t))}}class Z{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(t,o,r,a,s){this.type=1,this._$AH=c,this._$AN=void 0,this.element=t,this.name=o,this._$AM=a,this.options=s,r.length>2||r[0]!==""||r[1]!==""?(this._$AH=Array(r.length-1).fill(new String),this.strings=r):this._$AH=c}_$AI(t,o=this,r,a){const s=this.strings;let i=!1;if(s===void 0)t=D(this,t,o,0),i=!z(t)||t!==this._$AH&&t!==T,i&&(this._$AH=t);else{const h=t;let l,u;for(t=s[0],l=0;l<s.length-1;l++)u=D(this,h[r+l],o,l),u===T&&(u=this._$AH[l]),i||=!z(u)||u!==this._$AH[l],u===c?t=c:t!==c&&(t+=(u??"")+s[l+1]),this._$AH[l]=u}i&&!a&&this.j(t)}j(t){t===c?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,t??"")}}class de extends Z{constructor(){super(...arguments),this.type=3}j(t){this.element[this.name]=t===c?void 0:t}}class ce extends Z{constructor(){super(...arguments),this.type=4}j(t){this.element.toggleAttribute(this.name,!!t&&t!==c)}}class he extends Z{constructor(t,o,r,a,s){super(t,o,r,a,s),this.type=5}_$AI(t,o=this){if((t=D(this,t,o,0)??c)===T)return;const r=this._$AH,a=t===c&&r!==c||t.capture!==r.capture||t.once!==r.once||t.passive!==r.passive,s=t!==c&&(r===c||a);a&&this.element.removeEventListener(this.name,this,r),s&&this.element.addEventListener(this.name,this,t),this._$AH=t}handleEvent(t){typeof this._$AH=="function"?this._$AH.call(this.options?.host??this.element,t):this._$AH.handleEvent(t)}}class pe{constructor(t,o,r){this.element=t,this.type=6,this._$AN=void 0,this._$AM=o,this.options=r}get _$AU(){return this._$AM._$AU}_$AI(t){D(this,t)}}const ue=at.litHtmlPolyfillSupport;ue?.(q,j),(at.litHtmlVersions??=[]).push("3.3.1");const be=(e,t,o)=>{const r=o?.renderBefore??t;let a=r._$litPart$;if(a===void 0){const s=o?.renderBefore??null;r._$litPart$=a=new j(t.insertBefore(I(),s),s,void 0,o??{})}return a._$AI(e),a},it=globalThis;let f=class extends B{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){const e=super.createRenderRoot();return this.renderOptions.renderBefore??=e.firstChild,e}update(e){const t=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=be(t,this.renderRoot,this.renderOptions)}connectedCallback(){super.connectedCallback(),this._$Do?.setConnected(!0)}disconnectedCallback(){super.disconnectedCallback(),this._$Do?.setConnected(!1)}render(){return T}};f._$litElement$=!0,f.finalized=!0,it.litElementHydrateSupport?.({LitElement:f});const ge=it.litElementPolyfillSupport;ge?.({LitElement:f});(it.litElementVersions??=[]).push("4.2.1");const me={ATTRIBUTE:1},ve=e=>(...t)=>({_$litDirective$:e,values:t});class fe{constructor(t){}get _$AU(){return this._$AM._$AU}_$AT(t,o,r){this._$Ct=t,this._$AM=o,this._$Ci=r}_$AS(t,o){return this.update(t,o)}update(t,o){return this.render(...o)}}const V=ve(class extends fe{constructor(e){if(super(e),e.type!==me.ATTRIBUTE||e.name!=="class"||e.strings?.length>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter((t=>e[t])).join(" ")+" "}update(e,[t]){if(this.st===void 0){this.st=new Set,e.strings!==void 0&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter((r=>r!==""))));for(const r in t)t[r]&&!this.nt?.has(r)&&this.st.add(r);return this.render(t)}const o=e.element.classList;for(const r of this.st)r in t||(o.remove(r),this.st.delete(r));for(const r in t){const a=!!t[r];a===this.st.has(r)||this.nt?.has(r)||(a?(o.add(r),this.st.add(r)):(o.remove(r),this.st.delete(r)))}return T}}),ye={attribute:!0,type:String,converter:K,reflect:!1,hasChanged:rt},$e=(e=ye,t,o)=>{const{kind:r,metadata:a}=o;let s=globalThis.litPropertyMetadata.get(a);if(s===void 0&&globalThis.litPropertyMetadata.set(a,s=new Map),r==="setter"&&((e=Object.create(e)).wrapped=!0),s.set(o.name,e),r==="accessor"){const{name:i}=o;return{set(h){const l=t.get.call(this);t.set.call(this,h),this.requestUpdate(i,l,e)},init(h){return h!==void 0&&this.C(i,void 0,e,h),h}}}if(r==="setter"){const{name:i}=o;return function(h){const l=this[i];t.call(this,h),this.requestUpdate(i,l,e)}}throw Error("Unsupported decorator location: "+r)};function n(e){return(t,o)=>typeof o=="object"?$e(e,t,o):((r,a,s)=>{const i=a.hasOwnProperty(s);return a.constructor.createProperty(s,r),i?Object.getOwnPropertyDescriptor(a,s):void 0})(e,t,o)}function x(e){return n({...e,state:!0,attribute:!1})}const _e=(e,t,o)=>(o.configurable=!0,o.enumerable=!0,Reflect.decorate&&typeof t!="object"&&Object.defineProperty(e,t,o),o);function Et(e){return(t,o)=>{const{slot:r,selector:a}=e??{},s="slot"+(r?`[name=${r}]`:":not([name])");return _e(t,o,{get(){const i=this.renderRoot?.querySelector(s),h=i?.assignedElements(e)??[];return a===void 0?h:h.filter((l=>l.matches(a)))}})}}var xe=Object.defineProperty,nt=(e,t,o,r)=>{for(var a=void 0,s=e.length-1,i;s>=0;s--)(i=e[s])&&(a=i(t,o,a)||a);return a&&xe(t,o,a),a};const Ct=class extends f{constructor(){super(...arguments),this.progressValue=0,this._progressState="reset",this._progressWidth=0}_onProgressAnimationEnd(){["error","success"].includes(this._progressState)&&(this._progressState="reset")}render(){return d` <div class="wrapper">
  ...
  `;let F=Ct;nt([n({attribute:"progress-value",type:Number})],F.prototype,"progressValue");nt([x()],F.prototype,"_progressState");nt([x()],F.prototype,"_progressWidth");function O(){return A`1px solid color-mix(in oklch, var(--admin-bar-color-text), transparent 90%)`}function Pt(){return A`
    & {
  ...
  `}var we=Object.defineProperty,Ae=(e,t,o,r)=>{for(var a=void 0,s=e.length-1,i;s>=0;s--)(i=e[s])&&(a=i(t,o,a)||a);return a&&we(t,o,a),a};const Ut=class extends f{constructor(){super(...arguments),this.textContent=""}render(){return d`<span class="admin-bar-badge"><slot>${this.textContent}</slot></span>`}};Ut.styles=A`
    :host {
      padding: 0.4em;
  ...
  `;let v=Q;y([n({attribute:"badge-content"})],v.prototype,"badgeContent");y([n({attribute:"badge-position"})],v.prototype,"badgePosition");y([n({attribute:"button-aria-label"})],v.prototype,"buttonAriaLabel");y([n({attribute:"button-href"})],v.prototype,"href");y([n({attribute:"disabled",type:Boolean})],v.prototype,"buttonDisabled");y([n({attribute:"label-text"})],v.prototype,"label");y([n({attribute:"greeting-button",type:Boolean})],v.prototype,"isGreetingButton");y([n({attribute:"logout-button",type:Boolean})],v.prototype,"isLogoutButton");y([x()],v.prototype,"_hasPopoverSlot");y([x()],v.prototype,"_inVertical");y([x()],v.prototype,"_popoverOpen");y([Et({flatten:!0,slot:"popover"})],v.prototype,"_popoverFocusableChildren");const Ot=class Bt extends Event{constructor(t,o){super(Bt.eventName,{bubbles:!0,composed:!0}),this.newState="closed",this.oldState="closed",this.open=!1,this.newState=o,this.oldState=t,this.open=o==="open"}};Ot.eventName="toggle";let Se=Ot;const Dt=class Nt extends Event{constructor(){super(Nt.eventName,{bubbles:!0,composed:!0})}};Dt.eventName="opened";let Ee=Dt;const Lt=class Rt extends Event{constructor(){super(Rt.eventName,{bubbles:!0,composed:!0})}};Lt.eventName="closed";let Ce=Lt;function Pe(e,t){function o(s){if(s.button!==0)return;let{x:i,y:h}=e.eventToCoordinates(s);e.dragging={dx:e.pos.x-i,dy:e.pos.y-h},t.classList.add("dragging"),t.setPointerCapture(s.pointerId),t.style.userSelect="none",t.style.webkitUserSelect="none"}function r(){e.dragging=null,t.classList.remove("dragging"),t.style.userSelect="",t.style.webkitUserSelect=""}function a(s){if(!e.dragging)return;let{x:i,y:h}=e.eventToCoordinates(s);e.pos={x:i+e.dragging.dx,y:h+e.dragging.dy}}t.addEventListener("pointerdown",o),t.addEventListener("pointerup",r),t.addEventListener("pointercancel",r),t.addEventListener("pointermove",a),t.addEventListener("touchstart",s=>s.preventDefault()),t.addEventListener("dragstart",s=>s.preventDefault())}d`<svg
...
>
  ...
  `;let b=Mt;g([n({attribute:"auto-toggle-vertical",type:Number})],b.prototype,"autoToggleVertical");g([n({attribute:"avatar-alt"})],b.prototype,"avatarAlt");g([n({attribute:"avatar-src"})],b.prototype,"avatarSrc");g([n({attribute:"environment-description"})],b.prototype,"environmentDescription");g([n({attribute:"greeting-button-aria-label"})],b.prototype,"greetingButtonAriaLabel");g([n({attribute:"greeting-text"})],b.prototype,"greetingText");g([n({attribute:"logout-href"})],b.prototype,"logoutHref");g([n({attribute:"logout-label"})],b.prototype,"logoutLabel");g([n({attribute:"progress",type:Number})],b.prototype,"progressValue");g([n({attribute:"show-environment",type:Boolean})],b.prototype,"showEnvironment");g([n({attribute:"show-greeting",type:Boolean})],b.prototype,"showGreeting");g([n({attribute:"show-logout",type:Boolean})],b.prototype,"showLogout");g([n({attribute:"toolbar-toggle",reflect:!0})],b.prototype,"toolbarToggle");g([n({attribute:"toolbar-toggle-drag",reflect:!0})],b.prototype,"toolbarToggleDrag");g([n({attribute:"toolbar-toggle-drag-handle-description"})],b.prototype,"toolbarToggleDragHandleDescription");g([n({attribute:"toolbar-toggle-inner-description"})],b.prototype,"toolbarToggleInnerDescription");g([n({attribute:"toolbar-toggle-outer-description"})],b.prototype,"toolbarToggleOuterDescription");g([n({attribute:"vertical",reflect:!0,type:Boolean})],b.prototype,"toolbarVertical");g([x()],b.prototype,"_outerToggleDraggableState");g([x()],b.prototype,"_hasGreetingPopoverSlot");g([x()],b.prototype,"_hostWidth");g([Et({flatten:!0,selector:"admin-bar-button"})],b.prototype,"_adminBarButtonChildren");var De=Object.defineProperty,k=(e,t,o,r)=>{for(var a=void 0,s=e.length-1,i;s>=0;s--)(i=e[s])&&(a=i(t,o,a)||a);return a&&De(t,o,a),a};const tt=class extends f{constructor(){super(...arguments),this.inputChecked=!1,this.inputDisabled=!1,this.inputLabel="",this.inputName="checkbox",this.inputSwitch=!1,this.labelPosition="after",this._hasCheckedIconSlot=!1,this._hasUncheckedIconSlot=!1,this._readyForUpdates=!1}handleCheckedIconSlotchange(t){const o=t.target.assignedNodes({flatten:!0});this._hasCheckedIconSlot=o.length>0}handleUncheckedIconSlotchange(t){const o=t.target.assignedNodes({flatten:!0});this._hasUncheckedIconSlot=o.length>0}_toggleChecked(){this.inputChecked=!this.inputChecked}firstUpdated(t){this._readyForUpdates=!0}render(){const t=d`<slot>${this.inputLabel}</slot>`,o=this.inputChecked?d`<slot name="checked-icon" @slotchange="${this.handleCheckedIconSlotchange}"></slot>`:d`<slot name="unchecked-icon" @slotchange="${this.handleUncheckedIconSlotchange}"></slot>`,r={"admin-bar-checkbox":!0,"admin-bar-checkbox--disabled":this.inputDisabled,"admin-bar-checkbox--has-icon":this.inputChecked?this._hasCheckedIconSlot:this._hasUncheckedIconSlot};return d`<label class="${V(r)}"
    ...
    >`}willUpdate(t){this._readyForUpdates&&t.has("inputChecked")&&(this.dispatchEvent(new Ne(this.inputChecked)),this.inputChecked?this.dispatchEvent(new Le):this.dispatchEvent(new Re))}};tt.shadowRootOptions={...f.shadowRootOptions,delegatesFocus:!0},tt.styles=A`
    :host {
      display: block;
  ...
  `;let w=tt;k([n({attribute:"input-aria-label"})],w.prototype,"inputAriaLabel");k([n({attribute:"checked",reflect:!0,type:Boolean,useDefault:!0})],w.prototype,"inputChecked");k([n({attribute:"disabled",type:Boolean})],w.prototype,"inputDisabled");k([n({attribute:"label-text"})],w.prototype,"inputLabel");k([n({attribute:"input-name"})],w.prototype,"inputName");k([n({attribute:"input-switch",type:Boolean})],w.prototype,"inputSwitch");k([n({attribute:"label-position"})],w.prototype,"labelPosition");k([x()],w.prototype,"_hasCheckedIconSlot");k([x()],w.prototype,"_hasUncheckedIconSlot");k([x()],w.prototype,"_readyForUpdates");const Ht=class Vt extends Event{constructor(t){super(Vt.eventName,{bubbles:!0,composed:!0}),this.checked=!1,this.checked=t}};Ht.eventName="change";let Ne=Ht;const It=class zt extends Event{constructor(){super(zt.eventName,{bubbles:!0,composed:!0})}};It.eventName="checked";let Le=It;const qt=class jt extends Event{constructor(){super(jt.eventName,{bubbles:!0,composed:!0})}};qt.eventName="unchecked";let Re=qt;var Me=Object.defineProperty,N=(e,t,o,r)=>{for(var a=void 0,s=e.length-1,i;s>=0;s--)(i=e[s])&&(a=i(t,o,a)||a);return a&&Me(t,o,a),a};const Ft=class extends f{constructor(){super(),this.dlContent=[],this.badgeContent="",this.badgePosition="before",this.multiLine=!1,this.tableContent={rows:[]},this.textContent="",customElements.get("admin-bar-badge")||customElements.define("admin-bar-badge",lt)}render(){const t=[];this.textContent??!1?t.push(d`<span class="text">${this.textContent}</span>`):this.dlContent.length?t.push(d`<dl part="dl">
        ...
        </table>`);let o=d`<slot>${t}</slot>`;return(this.badgeContent??!1)&&(o=this.badgePosition==="before"?d`<admin-bar-badge part="badge">${this.badgeContent}</admin-bar-badge>${o}`:d`${o}<admin-bar-badge part="badge">${this.badgeContent}</admin-bar-badge>`),d`<span class="admin-bar-text${this.multiLine?" multi-line":""}">${o}</span>`}};Ft.styles=A`
    :host {
      display: flex;
      align-items: center;
      min-height: var(--admin-bar-height, 43px);
