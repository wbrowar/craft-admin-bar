 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const B=Lt(class extends zt{constructor(o){var t;if(super(o),o.type!==Rt.ATTRIBUTE||o.name!=="class"||((t=o.strings)==null?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(o){return" "+Object.keys(o).filter(t=>o[t]).join(" ")+" "}update(o,[t]){var e,r;if(this.st===void 0){this.st=new Set,o.strings!==void 0&&(this.nt=new Set(o.strings.join(" ").split(/\s/).filter(a=>a!=="")));for(const a in t)t[a]&&!((e=this.nt)!=null&&e.has(a))&&this.st.add(a);return this.render(t)}const i=o.element.classList;for(const a of this.st)a in t||(i.remove(a),this.st.delete(a));for(const a in t){const n=!!t[a];n===this.st.has(a)||(r=this.nt)!=null&&r.has(a)||(n?(i.add(a),this.st.add(a)):(i.remove(a),this.st.delete(a)))}return E}});/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const jt={attribute:!0,type:String,converter:D,reflect:!1,hasChanged:J},Bt=(o=jt,t,e)=>{const{kind:r,metadata:i}=e;let a=globalThis.litPropertyMetadata.get(i);if(a===void 0&&globalThis.litPropertyMetadata.set(i,a=new Map),a.set(e.name,o),r==="accessor"){const{name:n}=e;return{set(l){const s=t.get.call(this);t.set.call(this,l),this.requestUpdate(n,s,o)},init(l){return l!==void 0&&this.P(n,void 0,o),l}}}if(r==="setter"){const{name:n}=e;return function(l){const s=this[n];t.call(this,l),this.requestUpdate(n,s,o)}}throw Error("Unsupported decorator location: "+r)};function u(o){return(t,e)=>typeof e=="object"?Bt(o,t,e):((r,i,a)=>{const n=i.hasOwnProperty(a);return i.constructor.createProperty(a,n?{...r,wrapped:!0}:r),n?Object.getOwnPropertyDescriptor(i,a):void 0})(o,t,e)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Dt(o){return u({...o,state:!0,attribute:!1})}var It=Object.defineProperty,Vt=Object.getOwnPropertyDescriptor,L=(o,t,e,r)=>{for(var i=r>1?void 0:r?Vt(t,e):t,a=o.length-1,n;a>=0;a--)(n=o[a])&&(i=(r?n(t,e,i):n(i))||i);return r&&i&&It(t,e,i),i};let k=class extends A{constructor(){super(...arguments),this.label="",this.isLogoutButton=!1,this._hasPopoverSlot=!1}handlePopoverSlotchange(o){const t=o.target.assignedNodes({flatten:!0});this._hasPopoverSlot=t.length>0}render(){const o={"admin-bar-button":!0,"admin-bar-button--el-a":!1,"admin-bar-button--el-button":!1,"admin-bar-button--el-select":!1,"admin-bar-button--logout":this.isLogoutButton},t=h`<slot name="label-before"></slot
      ><slot>${this.label??!1?h`<span>${this.label}</span>`:c}</slot
      ><slot name="label-after"></slot>`;return this.href?(o["admin-bar-button--el-a"]=!0,h`<a class="${B(o)}" href="${this.href}">${t}</a>`):(o["admin-bar-button--el-button"]=!0,this._hasPopoverSlot?h`<button class="${B(o)}" popovertarget="admin-bar-button-popover">
          ${t}
        </button>
        ...
        </div>`:h`<button class="${B(o)}">${t}</button
      ><slot name="popover" @slotchange="${this.handlePopoverSlotchange}"></slot>`)}};k.styles=W`
    :host {
      --padding-left: 10px;
      --padding-right: 10px;
      --margin: 4px;
  ...
  `;L([u({attribute:"button-href",type:[String,Function,Array]})],k.prototype,"href",2);L([u({attribute:"label-text"})],k.prototype,"label",2);L([u({attribute:"logout-button",type:Boolean})],k.prototype,"isLogoutButton",2);L([Dt()],k.prototype,"_hasPopoverSlot",2);k=L([Z("admin-bar-button")],k);function Wt(){return W`
    /*
  ...
  `;$([u({attribute:"avatar-alt"})],g.prototype,"avatarAlt",2);$([u({attribute:"avatar-src"})],g.prototype,"avatarSrc",2);$([u({attribute:"greeting-text"})],g.prototype,"greetingText",2);$([u({attribute:"logout-href"})],g.prototype,"logoutHref",2);$([u({attribute:"logout-label"})],g.prototype,"logoutLabel",2);$([u({attribute:"show-environment",type:Boolean})],g.prototype,"showEnvironment",2);$([u({attribute:"show-greeting",type:Boolean})],g.prototype,"showGreeting",2);$([u({attribute:"show-logout",type:Boolean})],g.prototype,"showLogout",2);g=$([Z("admin-bar")],g);var Yt=Object.defineProperty,Ft=Object.getOwnPropertyDescriptor,S=(o,t,e,r)=>{for(var i=r>1?void 0:r?Ft(t,e):t,a=o.length-1,n;a>=0;a--)(n=o[a])&&(i=(r?n(t,e,i):n(i))||i);return r&&i&&Yt(t,e,i),i};let v=class extends A{constructor(){super(...arguments),this.dlContent=[],this.labelContent="",this.labelPosition="after",this.multiLine=!1,this.tableContent={rows:[]},this.textContent=""}render(){var o,t,e,r,i,a;const n=[];this.textContent??!1?n.push(h`<span class="text">${this.textContent}</span>`):this.dlContent.length?n.push(h`<dl>
          ${this.dlContent.map(s=>h`<dt>${s[0]??""}</dt>
                <dd>${s[1]??""}</dd>`)}
        </dl>`):(t=(o=this.tableContent)==null?void 0:o.rows)!=null&&t.length&&n.push(h`<table>
          ${(r=(e=this.tableContent)==null?void 0:e.headers)!=null&&r.length?h`<thead>
                <tr>
                  ${this.tableContent.headers.map(s=>h`<th>${s??""}</th>`)}
                </tr>
              </thead>`:c}
          ${h`<tbody>
            ${this.tableContent.rows.map(s=>h`<tr>
                  ${s.map(p=>h`<td>${p}</td>`)}
                </tr>`)}
          </tbody>`}
          ${(a=(i=this.tableContent)==null?void 0:i.footers)!=null&&a.length?h`<tfoot>
                <tr>
                  ${this.tableContent.footers.map(s=>h`<td>${s??""}</td>`)}
                </tr>
              </tfoot>`:c}
        </table>`);let l=h`<slot>${n}</slot>`;return(this.labelContent??!1)&&(l=this.labelPosition==="before"?h`<span class="label">${this.labelContent}</span>${l}`:h`${l}<span class="label">${this.labelContent}</span>`),h`<span class="admin-bar-text${this.multiLine?" multi-line":""}">${l}</span>`}};v.styles=W`
    :host {
      --padding-left: 10px;
      --padding-right: 10px;
      --margin: 4px;
  ...
  `;S([u({attribute:"dl-content",type:Array})],v.prototype,"dlContent",2);S([u({attribute:"label-content"})],v.prototype,"labelContent",2);S([u({attribute:"label-position"})],v.prototype,"labelPosition",2);S([u({attribute:"multi-line",type:Boolean})],v.prototype,"multiLine",2);S([u({attribute:"table-content",type:Object})],v.prototype,"tableContent",2);S([u({attribute:"text-content"})],v.prototype,"textContent",2);v=S([Z("admin-bar-text")],v);
